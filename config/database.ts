...
const dbConfig = defineConfig({
  ...
  connections: {
    ...
    pg: {
      client: 'pg',
      connection: {
        host: env.get('DB_HOST') as string | undefined,
        port: env.get('DB_PORT') as number | undefined,
        user: env.get('DB_USER') as string | undefined,
        password: env.get('DB_PASSWORD') as string | undefined,
        database: env.get('DB_DATABASE') as string | undefined,
      },
      migrations: {
        naturalSort: true,
        paths: ['database/migrations'],
